...
if [ ! -e "/etc/csf/csf.conf" ]; then
	cp -avf etc/conf/vesta/csf.conf /etc/csf/csf.conf
fi
...
if [ ! -e "/etc/csf/csf.allow" ]; then
	cp -avf etc/conf/vesta/csf.allow /etc/csf/csf.allow
fi
...
if [ ! -e "/etc/csf/csf.ignore" ]; then
	cp -avf etc/conf/vesta/csf.ignore /etc/csf/csf.ignore
fi
if [ ! -e "/etc/csf/csf.pignore" ]; then
	cp -avf etc/conf/vesta/csf.pignore /etc/csf/csf.pignore
fi
...
cp -avf etc/conf/vesta/csf.conf /usr/local/csf/profiles/reset_to_defaults.conf
...
mkdir -v -p -m 0600 /usr/local/vesta/web/list/csf/
