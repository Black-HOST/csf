...
install_dependencies() {
    ...
    if [[ "$PM" == "apt" ]]; then
        ...
        install_package "--allowerasing wget tar curl perl perl-libwww-perl.noarch perl-LWP-Protocol-https.noarch perl-GDGraph perl-Math-BigInt.noarch iptables kernel-modules-extra bind-utils unzip sendmail"
    else
