...
if [ ! -e "/etc/csf/csf.conf" ]; then
	cp -avf etc/conf/interworx/csf.conf /etc/csf/csf.conf
fi
...
if [ ! -e "/etc/csf/csf.allow" ]; then
	cp -avf etc/conf/interworx/csf.allow /etc/csf/csf.allow
fi
...
if [ ! -e "/etc/csf/csf.ignore" ]; then
	cp -avf etc/conf/interworx/csf.ignore /etc/csf/csf.ignore
fi
if [ ! -e "/etc/csf/csf.pignore" ]; then
	cp -avf etc/conf/interworx/csf.pignore /etc/csf/csf.pignore
fi
...
cp -avf etc/conf/interworx/csf.conf /usr/local/csf/profiles/reset_to_defaults.conf
...
mkdir -v -p -m 0600 /usr/local/interworx/plugins/configservercsf /usr/local/interworx/html/configserver
chmod -v 0711 /usr/local/interworx/html/configserver
cp -avf panels/interworx/* /usr/local/interworx/plugins/configservercsf
cp -avf panels/csf /usr/local/interworx/html/configserver/
