...
if [ ! -e "/etc/csf/csf.conf" ]; then
	cp -avf etc/conf/cwp/csf.conf /etc/csf/csf.conf
fi
...
if [ ! -e "/etc/csf/csf.allow" ]; then
	cp -avf etc/conf/cwp/csf.allow /etc/csf/csf.allow
fi
...
if [ ! -e "/etc/csf/csf.ignore" ]; then
	cp -avf etc/conf/cwp/csf.ignore /etc/csf/csf.ignore
fi
if [ ! -e "/etc/csf/csf.pignore" ]; then
	cp -avf etc/conf/cwp/csf.pignore /etc/csf/csf.pignore
fi
...
cp -avf etc/conf/cwp/csf.conf /usr/local/csf/profiles/reset_to_defaults.conf
...
mkdir -v -p -m 0600 /usr/local/cwpsrv/htdocs/admin/design/csf/
cp -avf panels/csf/* /usr/local/cwpsrv/htdocs/admin/design/csf/
